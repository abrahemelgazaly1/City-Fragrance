    ...
    return (
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex flex-col items-center justify-center py-20">
          ...
          <p className="text-xl font-bold text-gray-700">Loading perfumes...</p>
        </div>
      </div>
    );
  }
    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      {categoryProducts.length === 0 ? (
        <div className="text-center py-20">
          ...
          <h2 className="text-2xl font-bold text-gray-700 mb-2">No Perfumes Found</h2>
          <p className="text-gray-500">There are no perfumes in this category at the moment</p>
        </div>
      ) : (
